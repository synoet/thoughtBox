      ...
      <Flex direction="row" w="100%" position="relative">
        ...
        {type === "boolean" && (
          <Box
            ...
            position="absolute"
            marginLeft={`${
              50 - ((data.no - data.yes) / (data.no + data.yes)) * 100
            }%`}
            zIndex="2"
          />
        )}
        {type === "spectrum" && (
          <Box
            ...
            position="absolute"
            marginLeft={`${
              50 + ((data.good - data.bad) / (data.good + data.bad)) * 100
            }%`}
            zIndex="2"
          />
        )}
        {type === "boolean" && (
          <Text
            ...
            marginTop="2rem"
            marginLeft={`${
              50 - ((data.no - data.yes) / (data.no + data.yes)) * 100 - 2
            }%`}
          >
            Average
          </Text>
        ...
        {type === "spectrum" && (
          <Text
            ...
            marginTop="2rem"
            marginLeft={`${
              50 + ((data.good - data.bad) / (data.good + data.bad)) * 100 - 2
            }%`}
          >
            Average
          </Text>
